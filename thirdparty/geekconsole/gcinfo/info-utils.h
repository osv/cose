...
char* info_parse_node (char *string, int newlines_okay);
...
extern void info_parse_label_line (char *label, char *nodeline);
#define info_node_label_of_line(n) info_parse_label_line (INFO_NODE_LABEL, n)
#define info_file_label_of_line(n) info_parse_label_line (INFO_FILE_LABEL, n)
#define info_next_label_of_line(n) info_parse_label_line (INFO_NEXT_LABEL, n)
#define info_up_label_of_line(n)   info_parse_label_line (INFO_UP_LABEL, n)
#define info_prev_label_of_line(n) \
  do { \
    info_parse_label_line (INFO_PREV_LABEL, n); \
    if (!info_parsed_nodename && !info_parsed_filename) \
      info_parse_label_line (INFO_ALTPREV_LABEL, n); \
  } while (0)
